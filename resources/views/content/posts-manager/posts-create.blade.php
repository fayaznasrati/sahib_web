                                    ...
                                    <div class="row">
                                        <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                            <div class="input-item mb-4">
                                                ...
                                                <select class="form-control" name="category_id"id="select-menus"  type="text" class="input-item">
                                        ...
                                        <div class="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                            <div class="input-item mb-4">
                                                ...
                                                <select class="form-control" name="sub_category_id"id="sub-menu"  type="text" class="input-item">
                                ...
                                <span class="row ">
                                    ...
                                    <div class="col-md-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                        <div class="input-item mb-5">
                                            ...
                                            <input class="form-control"  name="title_desc[]" type="text" placeholder="body">
                                        </div>
                                    </div>
