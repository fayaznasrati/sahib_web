    ...
    <div class="container">
        ...
        <div class="row mb-n6 overflow-hidden">
            ...
            <div class="col-md-6 col-12 mb-6">
                <div class="banner aos-init aos-animate" data-aos="fade-right" data-aos-delay="300">
            ...
            <!-- Banner Start -->
            <div class="col-md-6 col-12 mb-6">
                <div class="banner aos-init aos-animate" data-aos="fade-left" data-aos-delay="500">
                    <div class="banner-image">
