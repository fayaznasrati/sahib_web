                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-4 mb-10" data-aos="fade-up" data-aos-delay="200">
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-address">
                                <li><span>Address: </span>house 15, Lin 5B, street 15, Wazir Akbar khan, Kabul,Afg</li>
                                <li><span>Call to: </span> <a href="#"> (+93) 987654321</a></li>
                                <li><span>Mail to: </span> <a href="#"> info@sahib.af</a></li>
                            </ul>
                            <!-- Contact Address End -->
            ...
            <div class="row align-items-center">
                <div class="col-12 text-center">
                    <div class="copyright-content">
                        <p class="mb-0">Made width <i class="fa fa-heart text-danger"></i> by <a href="#">SAHIB.AF</a> © 2023</p>
                    </div>
                </div>
            </div>
        </div>
