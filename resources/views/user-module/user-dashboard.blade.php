...
<div style="z-index: 2000" class="bs-toast toast fade show bg-danger" role="alert" aria-live="assertive" aria-atomic="true">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <select id="city" name="city" class="select2 form-select">
                          ...
                          <option {{$user->city == $city->id? "selected":"14"}} value="{{$city->id}}">{{$city->name}}</option>
                          @endforeach
