                            ...
                            <div class="user-profile">
                                ...
                                <div class="profile-body">
                                    ...
                                    <div class="owner-contact-buttons">
                                        <a  href="https://api.whatsapp.com/send?phone={{ $post->user->whatsapp }}"
                                            target="_blank"><button class="contact-btn whatsBtn"><i style="color: grey"
                                                    class="fa fa-whatsapp"></i></button></a>
                                        <a href="mailto:{{ $post->user->email }}"><button
                                                class="contact-btn mailBtn"><i style="color: grey" class="pe-7s-mail"></i></button></a>
                                        <a href="{{ $post->user->mobile }}"><button class="contact-btn phoneBtn"><i style="color: grey"
                                                    class="pe-7s-phone"></i></button></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 ">
                                    ...
                                    @if ($sellerb != null)
                                        <a id="barnad-Name-on-single-post"
                                            href="/seller/comapany-info/{{ $sellerb->slug }}">Brand:
                                            {{ $sellerb->name }}</a>
                                    @endif
